			...
			<div class="team-info">
				...
				<div class="team-grids">
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s">
						<img src="images/haswati.jpg" alt="Team Member" style="width:200px;height:200px">
						<h6>Haswati Naskar</h6>
						<p>Technical Assistant Grade - I</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s">
						<img src="images/shreejani.jpg" alt="Krishak Bandhu Scheme" style="width:200px;height:200px">
						<h6>Shreejani Manna</h6>
						<p>Technical Assistant Grade - II</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s">
						<img src="images/o3.jpg"alt="Krishak Bandhu Scheme" style="width:200px;height:200px">
						<h6>Oindrila Batabyal</h6>
						<p>Technical Assistant Grade - III</p>		
					</div>
					<div class="clearfix"> </div>
					<script type="text/javascript">
